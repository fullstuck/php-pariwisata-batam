...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarExample">
           ...
           <!--     <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <form class="form-inline my-2 my-lg-0 mr-lg-2" action='user.php' method="POST">
                        <div class="input-group">
                            <input type="text" class="form-control" name='qcari' placeholder="Cari Fullname / Username">
    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <p><a class="btn btn-primary icon-btn" href="tambah-user.php"><i class="fa fa-plus"></i> Tambah User	</a></p>
              ...
              <div class="card-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
					...
					<td><center><strong><?php echo $data['username']; ?></strong></center></td>
					<td><center><?php echo $data['password'];?></center></td>
					<td><center><strong><?php echo $data['fullname']; ?></strong></center></td>
					<td><center><strong><?php echo $data['no_hp']; ?></strong></center></td>
					
					 <td><center><div id="thanks"><a class="btn btn-sm btn-info" data-placement="bottom" data-toggle="tooltip" title="Edit User" href="edit-user.php?hal=edit&kd=<?php echo $data['user_id'];?>"><span class="fa fa-pencil"> Edit</span></a>  
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['fullname'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus User" href="hapus-user.php?hal=hapus&kd=<?php echo $data['user_id'];?>"><span class="fa fa-trash-o"> Delete</span></a></center></td></tr></div>
                 <?php   
              } 
              ?>
